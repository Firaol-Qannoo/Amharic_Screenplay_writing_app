                                        ...
                                        <div className=" flex w-full gap-2">
                                            {templateCategories.map((category) => (
                                                <div key={category.name}  className={` space-y-4 w-full`}>
                                                    ...
                                                    <div  className="grid gap-4 text-gray-500   w-full ">
                                                        {category.templates.map((template) => (
                                                            <Card
                                                                key={template.id}
                                                                onClick={()=>changeTempType(category.name)} className={`${tempType==category.name ? "border-2 bg-gray-200 border-gray-300": ""} cursor-pointer text-gray-500 `}
